"""lakekeeper-mcp: Lakekeeper (Iceberg REST catalog) API + MCP Server + A2A Server."""
...
CORE_MODULES = ["lakekeeper_mcp.api_client"]
OPTIONAL_MODULES = {
    "lakekeeper_mcp.agent_server": "agent",
    "lakekeeper_mcp.mcp_server": "mcp",
}
